...
lappend search_path /home/IC/Labs/Lab_PNR_1/std_cells/libs
lappend search_path /home/IC/Labs/Lab_PNR_1/rtl
...
write_file -format verilog -hierarchy -output ALU_TOP.v
# DDC Gate Level Netlist
write_file -format ddc -hierarchy -output ALU_TOP.ddc
