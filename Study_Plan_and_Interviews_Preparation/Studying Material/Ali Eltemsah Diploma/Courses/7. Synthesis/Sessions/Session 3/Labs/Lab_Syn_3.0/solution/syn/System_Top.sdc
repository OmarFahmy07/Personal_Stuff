...
# Created by write_sdc on Fri Jul 29 18:22:17 2022
...
create_generated_clock [get_pins U0_CLK_GATE/GATED_CLK]  -name ALU_CLK  -source [get_ports CLK]  -master_clock CLK  -divide_by 1  -add
create_generated_clock [get_pins U0_ClkDiv/o_div_clk]  -name REG_CLK  -source [get_ports CLK]  -master_clock CLK  -divide_by 2  -add
...
set_input_delay -clock CLK  20  [get_ports CLKDIV_EN]
set_input_delay -clock CLK  20  [get_ports {ALU_FUN[3]}]
set_input_delay -clock CLK  20  [get_ports {ALU_FUN[2]}]
set_input_delay -clock CLK  20  [get_ports {ALU_FUN[1]}]
set_input_delay -clock CLK  20  [get_ports {ALU_FUN[0]}]
set_input_delay -clock CLK  20  [get_ports ALU_Enable]
set_input_delay -clock CLK  20  [get_ports WrEn]
set_input_delay -clock CLK  20  [get_ports RdEn]
set_input_delay -clock CLK  20  [get_ports {Address[3]}]
set_input_delay -clock CLK  20  [get_ports {Address[2]}]
set_input_delay -clock CLK  20  [get_ports {Address[1]}]
set_input_delay -clock CLK  20  [get_ports {Address[0]}]
set_input_delay -clock CLK  20  [get_ports {WrData[7]}]
set_input_delay -clock CLK  20  [get_ports {WrData[6]}]
set_input_delay -clock CLK  20  [get_ports {WrData[5]}]
set_input_delay -clock CLK  20  [get_ports {WrData[4]}]
set_input_delay -clock CLK  20  [get_ports {WrData[3]}]
set_input_delay -clock CLK  20  [get_ports {WrData[2]}]
set_input_delay -clock CLK  20  [get_ports {WrData[1]}]
set_input_delay -clock CLK  20  [get_ports {WrData[0]}]
set_output_delay -clock CLK  20  [get_ports {RdData[7]}]
set_output_delay -clock CLK  20  [get_ports {RdData[6]}]
set_output_delay -clock CLK  20  [get_ports {RdData[5]}]
set_output_delay -clock CLK  20  [get_ports {RdData[4]}]
set_output_delay -clock CLK  20  [get_ports {RdData[3]}]
set_output_delay -clock CLK  20  [get_ports {RdData[2]}]
set_output_delay -clock CLK  20  [get_ports {RdData[1]}]
set_output_delay -clock CLK  20  [get_ports {RdData[0]}]
set_output_delay -clock CLK  20  [get_ports ALU_VLD]
set_output_delay -clock CLK  20  [get_ports {ALU_OUT[7]}]
set_output_delay -clock CLK  20  [get_ports {ALU_OUT[6]}]
set_output_delay -clock CLK  20  [get_ports {ALU_OUT[5]}]
set_output_delay -clock CLK  20  [get_ports {ALU_OUT[4]}]
set_output_delay -clock CLK  20  [get_ports {ALU_OUT[3]}]
set_output_delay -clock CLK  20  [get_ports {ALU_OUT[2]}]
set_output_delay -clock CLK  20  [get_ports {ALU_OUT[1]}]
set_output_delay -clock CLK  20  [get_ports {ALU_OUT[0]}]
